...
(function (Data, Core) {
  ...
  Data.caseDefinitions = {
    "grain-warehouse": {
      ...
      trigger: function (state) {
        return state.world.flags.warehouseSuspicion;
      },
      choices: [
        {
          id: "audit",
          ...
          run: function (state) {
            ...
            return "공식 기록을 대조한 결과 일부 재고 차이가 확인됐다. 행정 기록에 흔적이 남았다.";
          }
        },
        {
          id: "negotiate",
          ...
          run: function (state) {
            ...
            return "상인들과 직접 조건을 맞췄다. 당장의 공급은 조금 안정됐지만 공식 기록에는 남지 않았다.";
          }
        },
        {
          id: "force",
          ...
          run: function (state) {
            ...
            return "강제로 문을 열었다. 숨겨진 물량 일부는 확인했지만 시장의 긴장도 함께 높아졌다.";
          }
        }
      ]
    },
      ...
      choices: [
        {
          ...
          run: function (state) {
            ...
            return "목격 내용을 경비대에 전달했다. 조사 기록이 정식으로 남았다.";
          }
        },
        {
          id: "follow",
          ...
          run: function (state) {
            ...
            return "부두 밖까지 흔적을 따라갔다. 화물이 북쪽 운송로와 연결된다는 정황을 얻었다.";
          }
        },
        {
          id: "ignore",
          ...
          run: function (state) {
            ...
            return "당장은 아무 일도 하지 않았다. 그 움직임은 기록되지 않은 채 사라졌다.";
          }
        }
      ]
    },
      ...
      choices: [
        {
          ...
          run: function (state) {
            ...
            return "기록 사본을 보존하도록 요청했다. 이후 조사자가 확인할 수 있는 흔적이 남았다.";
          }
        },
        {
          id: "owner",
          label: "현재 소유자에게 직접 확인",
          risk: 2,
          run: function (state) {
            state.player.money += 2;
            pushUnique(state.world.discovered, "landWitness");
            return "현 소유자에게서 오래된 거래 증언을 들었다. 문서보다 오래된 사정이 있다는 것을 알게 됐다.";
          }
        },
        {
          id: "alter",
          ...
          run: function (state) {
            ...
            return "기록 일부를 건드렸다. 당장은 문제가 없지만 행정 신뢰가 약간 흔들렸다.";
          }
        }
      ]
    }
  ...
  Data.resolveCase = function (state, caseId, choiceId) {
    ...
    if (roll >= need) {
      ...
      return {
        text: "【" + def.title + "】 " + choice.run(state) + " (판정 " + roll + "/" + need + ")",
        changed: true
      };
    }
    ...
    return {
      text: "【" + def.title + "】 " + choice.label + "은(는) 원하는 결과를 만들지 못했다. (판정 " + roll + "/" + need + ")",
      changed: true
    };
  };
