...
1. Stress-test long simulations across repeated entity-snapshot save/load cycles.
2. Extend the validated tutorial/end-state contract into a complete long-play and ending structure.
