...
- Actions submitted while the Worker is still initializing are queued until READY; queued actions drain through the fallback path if startup fails, with browser regression coverage
