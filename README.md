...
NPC의 개인 목표는 goalState로 구조화되며 일정 진입에 따라 진행도가 누적된다. 목표 달성 시 완료 상태와 완료 시각을 저장하고 해당 NPC의 소속 세력에도 작은 긍정 효과가 반영된다.

조직은 하루에 한 번 현재 세계 상태를 평가해 독립적인 의사결정을 내린다. 상인회·경비대·기록관·농촌 대표단·여관망·노동자 조합의 결정은 시장 재고, 치안, 긴장, 행정 신뢰, 소문 압력 등에 직접 영향을 준다.
...
1. NPC 목표 실패/중단/재설정과 관계망 연결
2. 조직 간 협력/충돌과 의사결정 경쟁 추가
